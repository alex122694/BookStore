...
import com.bookstore.order.OrderReturnRequest;
...
public class OrderController {
	...
	@ResponseBody
	public com.bookstore.common.SalesOverviewDTO getSalesOverviewApi(
			@RequestParam(value = "startDate", required = false) String startDateStr,
			@RequestParam(value = "endDate", required = false) String endDateStr) {
		java.sql.Timestamp start = parseTimestamp(startDateStr);
		java.sql.Timestamp end = parseTimestamp(endDateStr);
	...
	@ResponseBody
	public List<com.bookstore.common.MonthlySalesDTO> getRecentSalesRevenueApi() {
